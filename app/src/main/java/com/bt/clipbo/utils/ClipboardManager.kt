...
class ClipboardManager @Inject constructor(
     ...
     */
    suspend fun getCurrentClipboardContent(): Result<String?> = withContext(Dispatchers.Main) {
        try {
     ...
     */
    fun isSecureContent(content: String, type: ClipboardItem.ClipboardType): Boolean {
     ...
     */
    fun generatePreview(content: String, maxLength: Int = 100): String {
